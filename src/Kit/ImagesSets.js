...
export const monetaImagesSet = [
  { src: moneta1, alt: "moneta" },
  { src: moneta2, alt: "moneta" },
  { src: moneta3, alt: "moneta" },
  { src: moneta3, alt: "moneta" },
  { src: moneta4, alt: "moneta" },
  { src: moneta5, alt: "moneta" },
  { src: moneta6, alt: "moneta" },
  { src: moneta7, alt: "moneta" },
  { src: moneta8, alt: "moneta" },
  { src: moneta9, alt: "moneta" },
  { src: moneta10, alt: "moneta" },
]

export const kidtyImagesSet = [
  { src: kidty1, alt: "kidty" },
  { src: kidty2, alt: "kidty" },
  { src: kidty3, alt: "kidty" },
  { src: kidty3, alt: "kidty" },
  { src: kidty4, alt: "kidty" },
  { src: kidty5, alt: "kidty" },
  { src: kidty6, alt: "kidty" },
  { src: kidty7, alt: "kidty" }
]

export const phonesImagesSet = [
  { src: phones1, alt: "phones" },
  { src: phones2, alt: "phones" },
  { src: phones3, alt: "phones" },
  { src: phones3, alt: "phones" },
  { src: phones4, alt: "phones" },
  { src: phones5, alt: "phones" },
  { src: phones6, alt: "phones" },
  { src: phones7, alt: "phones" }
]

export const potsImagesSet = [
  { src: pots1, alt: "pots" },
  { src: pots2, alt: "pots" },
  { src: pots3, alt: "pots" },
  { src: pots3, alt: "pots" },
